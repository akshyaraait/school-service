...
namespace AkshyaraaIt\SchoolService\Controllers;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use AkshyaraaIt\SchoolService\Repositories\InstallRepository;
use AkshyaraaIt\Service\Repositories\InstallRepository as ServiceRepository;
use AkshyaraaIt\SchoolService\Requests\UserRequest;
